...
def main():
    ...
    """
    drawing_speed = 10000  # Bigger numbers mean faster drawing
    ...
    # better_draw_circles(rg.Point(200,200), 20)
    # better_draw_circles(rg.Point(-75,100), 9)
    # better_draw_circles(rg.Point(0,0), 3)
    # better_draw_circles(rg.Point(115,-150), 15)
    # even_better_draw_circles(rg.Point(0,0), 15, 5, 'red' , 4)
    # even_better_draw_circles(rg.Point(225,100), 3, 50, 'blue', 1)
    # even_better_draw_circles(rg.Point(0, 150), 150 , 3, 'turquoise', 10)
    even_better_draw_circles(rg.Point(0, 0), 1, 300, 'pink', 10)
    even_better_draw_circles(rg.Point(-100, 100), 50, 1, 'black', 2)
    even_better_draw_circles(rg.Point(100, 100), 50, 1, 'black', 2)
    even_better_draw_circles(rg.Point(-100, 100), 1, 48, 'yellow', 2)
    even_better_draw_circles(rg.Point(100, 100), 1, 48, 'yellow', 2)
    even_better_draw_circles(rg.Point(100, 100), 1, 25, 'black', 2)
    even_better_draw_circles(rg.Point(-100, 100), 1, 25, 'black', 2)
    even_better_draw_circles(rg.Point(0, 0), 70, 1, 'black', 2)
    even_better_draw_circles(rg.Point(25, 0), 1, 18, 'black', 2)
    even_better_draw_circles(rg.Point(-25, 0), 1, 18, 'black', 2)
...
def better_draw_circles(point, growth):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.right(90)
        turtle.forward(growth)
        turtle.left(90)

        turtle.pen_down()
        turtle.draw_circle(growth * k)
...
def even_better_draw_circles(point, growth, number, color, thickness):
    ...
    for k in range(1, num):  # k becomes 1, 2, 3, ... 10
