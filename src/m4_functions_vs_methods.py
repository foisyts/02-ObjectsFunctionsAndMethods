...
def try_methods():
    ...
    Then makes the SimpleTurtle move as follows (in the order listed):
      ...
      -- backward  100 units
    """
    felix = rg.SimpleTurtle()
    felix.pen = rg.Pen('brown', 5)
    felix.forward(150)
    felix.left(90)
    felix.forward(50)
    felix.backward(100)
...
def try_methods_and_functions():
    ...
    """
    kobe = rg.SimpleTurtle()
    kobe.pen = rg.Pen('blue', 5)

    kobe.backward(150)
    kobe.speed = 1
    draw_many_squares(kobe, 2, 100, 30)

    kobe.speed = 5
    kobe.pen = rg.Pen('red', 5)
    draw_many_squares(kobe, 10, 50, 15)

    kobe.speed = 100
    kobe.pen = rg.Pen('red', 35)
    draw_many_squares(kobe, 8, 300, 60)

    kobe.pen = rg.Pen('black', 3)
    kobe.backward(200)
    kobe.draw_circle(30)
    kobe.draw_square(50)
    ###########################################################################
